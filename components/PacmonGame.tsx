...
const CELL_SIZE = 20
const GAME_WIDTH = 28 * CELL_SIZE
const GAME_HEIGHT = 31 * CELL_SIZE

const INITIAL_PACMON_POSITION = { x: 13, y: 23 }
...
const PacmonGame: React.FC = () => {
  ...
  const [pacmon, setPacmon] = useState<Pacmon>({
    x: INITIAL_PACMON_POSITION.x * CELL_SIZE,
    y: INITIAL_PACMON_POSITION.y * CELL_SIZE,
    dx: 0,
    dy: 0,
    lives: 3,
  })
    ...
    >
      ...
      <div style={{ marginTop: '20px', textAlign: 'center' }}>
        {!isConnected ? (
          <button onClick={handleConnect} style={{
            padding: '8px 16px',
            margin: '5px',
            backgroundColor: COLORS.MAZE_BLUE,
            color: COLORS.TEXT_WHITE,
            border: 'none',
            borderRadius: '3px',
            cursor: 'pointer',
          ...
          <>
            ...
            <button onClick={handleDisconnect} style={{
              padding: '8px 16px',
              margin: '5px',
              backgroundColor: COLORS.GHOST_RED,
              color: COLORS.TEXT_WHITE,
              border: 'none',
              borderRadius: '3px',
              cursor: 'pointer',
            }}>Disconnect</button>
            <button onClick={handleSendTransaction} style={{
              padding: '8px 16px',
              margin: '5px',
              backgroundColor: COLORS.MAZE_BLUE,
              color: COLORS.TEXT_WHITE,
            ...
            <button onClick={handleGetBlockNumber} style={{
              padding: '8px 16px',
              margin: '5px',
              backgroundColor: COLORS.MAZE_BLUE,
              color: COLORS.TEXT_WHITE,
      ...
      <FarcasterFrame
        frame={
          frame || {
            version: 'vNext',
            image: 'https://pacmon-game.vercel.app/api/frame',
            postUrl: 'https://pacmon-game.vercel.app/api/frame',
            buttons: [
